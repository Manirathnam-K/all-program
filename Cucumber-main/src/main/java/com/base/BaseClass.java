...
protected static void switchToFrame(int index) {
    try {
        ...
        System.out.println("Unable to switch to frame by index");
    }
}
...
protected static void switchToFrame(String nameOrId) {
    try {
        ...
        System.out.println("Unable to switch to frame by name/id");
    }
}

// Switch to frame by WebElement
protected static void switchToFrame(WebElement frameElement) {
    try {
        driver.switchTo().frame(frameElement);
    } catch (Exception e) {
        System.out.println("Unable to switch to frame by element");
    }
}
